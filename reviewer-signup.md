...
<p>We’re planning a published edition of <em><a href="{{ site.baseurl }}{% post_url 2026-02-20-evolution-software-engineering-fortran-llms %}#conclusion">The evolution of software engineering from FORTRAN to LLMs</a></em> and would be grateful for your help. If you’d like to review the preprint, please fill out the form below.</p>
...
<form id="reviewer-signup-form" action="https://formspree.io/f/xldnywyl" method="POST">
  ...
  <div class="form-field">
    <label for="reviewer-note">Areas where you can help (e.g. technical review, copyediting, specific topics) (optional)</label>
