...
a [Techstars](https://www.techstars.com/newsroom/new-class-san-diego-sdsu){:target="_blank"}-backed company making [B2B data transfer](https://medium.com/@djpardis/the-state-of-data-exchange-31049fa229f0){:target="_blank"} seamless and secure. I also built [The Data Room App](https://thedataroom.app){:target="_blank"}, that offers simple and secure data rooms for fundraising.
